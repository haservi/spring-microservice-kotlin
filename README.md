...
요약: 스프링 클라우드의 기능 및 스프링 부트에 대한 편의성 소개
...
<p align="center">
  <img src="./docs/images/chapter2/image01.png" width="50%" height="50%">
</p>

아래와 같이 `ClassPathScanningCandidateComponentProvider.Java`는 내부 로직에서 아래 함수에서 @Repository, @Service, @Controller를 찾아서 추가됩니다.

<p align="center">
  <img src="./docs/images/chapter2/image02.png" width="50%" height="50%" alt="image">
</p>
